// User Delete Modal - Confirmation before deleting user
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 font-poppins mb-2">Hapus User?</h3>
                    <p className="text-gray-500 font-urbanist mb-6">
                        Anda yakin ingin menghapus <strong>"{userName}"</strong>? Semua data terkait user ini akan dihapus.
                    </p>
