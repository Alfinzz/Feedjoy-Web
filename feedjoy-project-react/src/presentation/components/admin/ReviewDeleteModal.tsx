// Review Delete Modal - Confirmation before deleting review
import { Trash2 } from 'lucide-react';

export interface ReviewDeleteModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 font-poppins mb-2">Hapus Review?</h3>
                    <p className="text-gray-500 font-urbanist mb-6">
                        Review yang dihapus tidak dapat dikembalikan. Yakin ingin melanjutkan?
                    </p>
